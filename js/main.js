    ...
    fetch('https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?CMC_PRO_API_KEY=' + 
        ...
        .then((api) => {
            ...
            for (let i = 0; i < 49; i++){
                ...
                else if (api.data[i].symbol === "LEO") {logoUrl = "https://cryptologos.cc/logos/unus-sed-leo-leo-logo.png?v=007";}                
                else if (api.data[i].symbol === "YFI") {logoUrl = "https://cryptologos.cc/logos/yearn-finance-yfi-logo.png?v=007";}                
                else if (api.data[i].symbol === "SNX") {logoUrl = "https://cryptologos.cc/logos/synthetix-network-token-snx-logo.png?v=007";}                
